...
// Import the type for 'material'
import { MaterialType } from '../your-material-type-path'; // Replace with the actual path
  ...
  return (
    <section className="p-4">
      ...
      <ul className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {materials.map((material: MaterialType) => ( // Use MaterialType here
